...
f4 = open("../Results/Currency_Country/Main_Currency_Country_Accuracy.txt", "w+", encoding="utf-8")
f5 = open("../Results/Currency_Country/Main_Currency_Country_Average_Accuracy.txt", "w+", encoding="utf-8")
